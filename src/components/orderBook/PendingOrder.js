...
//       <Paper sx={{ width: "100%", mb: 2,borderRadius:"1rem",height:"100%" , background: "#141e2f"}}>
...
export default function PendingOrder() {
  ...
  return (
    <div className="data-grid-container pendingOrder_wrapper">
      <h3 className="pending_text">PENDING ORDERS</h3>
